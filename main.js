...
//     let numeroIngresado = prompt(`Adivina el número (entre 1 y 10). Intento ${i} de ${intentos}:`);
...
// let mood = prompt("¿Qué tal andas hoy? Dime un color.").toLowerCase();
...
//         break;
//     case "azul":
//         alert("Tranqui, colega.");
//         break;
//     case "verde":
//         alert("Hoy puede ser un día genial :)");
//         break;
//     case "amarillo":
//         alert("Alguien se ha levantado con el pie derecho.");
//         break;
//     case "gris":
...
//         break;
//     default:
//         alert("Interesante elección. pero no lo tengo :(");
// }
